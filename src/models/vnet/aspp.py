...
class GroupNorm32(nn.GroupNorm):
    def __init__(self, num_channels):
        super(GroupNorm32, self).__init__(num_channels=num_channels, num_groups=16)
...
class ASPP(nn.Module):
    def __init__(self, inplanes, planes, norm_layer=GroupNorm32, dilations=[1, 6, 12, 18], dropout=0.5):
